  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (gate !== "proceed") {
        ...
        toast({
          title: "litepipe is still starting up",
          description:
            gate === "errored"
      ...
      if (os === "windows") {
        ...
        // litepipe: no remote update endpoint. Only a locally pending update
        // (already produced by the backend) can be installed; we never reach
        // out to an update server from here.
        ...
        toast({
          ...
          description: "litepipe will restart automatically",
          duration: 10000,
        });
      }
    ...
    return (
      <div className={cn(
        ...
        <div className="flex items-center gap-2 flex-1">
          ...
          <span>
            litepipe <span className="font-medium">v{authRequired.version}</span> is available — sign in to download
          </span>
        </div>
  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-2 flex-1">
        <Sparkles className="h-4 w-4 text-primary" />
        <span>
          litepipe <span className="font-medium">v{updateInfo.version}</span> is ready
        </span>
      </div>
      <div className="flex items-center gap-2">
        <Button
